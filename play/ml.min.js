...
var parse = function(json) {
    if ("zip" === json.type) {
      ...
      var mob = getMob(me);
      mob && (json.t ? (jv.transition = 1, map_fade.alpha = 1, jv.map_title.alpha = 0, dest = -1, last_dest = Date.now()) : inbounds(mob.x, mob.y) && (dest = -1), mob.x = json.x, mob.y = json.y, mob.fromx = json.x, mob.fromy = json.y, mob.tweenx = 0, mob.tweeny = 0, mob.traveled = 0, mob.last_check = Date.now(), mob.update_pos(), update_container())
