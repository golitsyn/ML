  ...
  e.prototype = {
    ...
    volume: function(e) {
      ...
      if (e = parseFloat(e), t.ctx || _(), void 0 !== e && 0 <= e && e <= 1) {
        if (t._volume = e, !t._muted) {
          ...
          for (var i = 0; i < t._howls.length; i++) if (!t._howls[i]._webAudio) for (var o = t._howls[i]._getSoundIds(), n = 0; n < o.length; n++) {
    ...
    _unlockAudio: function() {
      ...
      if (!l._audioUnlocked && l.ctx) return l._audioUnlocked = !1, l.autoUnlock = !1, l._mobileUnloaded || 44100 === l.ctx.sampleRate || (l._mobileUnloaded = !0, l.unload()), l._scratchBuffer = l.ctx.createBuffer(1, 1, 22050), s = function(e) {
        ...
        for (t = 0; t < l._howls.length; t++) if (!l._howls[t]._webAudio) for (var o = l._howls[t]._getSoundIds(), n = 0; n < o.length; n++) {
    ...
    _obtainHtml5Audio: function() {
      var e = this || f;
      return e._html5AudioPool.length ? e._html5AudioPool.pop() : ((e = (new Audio).play()) && "undefined" != typeof Promise && (e instanceof Promise || "function" == typeof e.then) && e.
      catch (function() {
  ...
  var f = new e,
    a = (t.prototype = {
      ...
      pause: function(e) {
        ...
        else for (var i = t._getSoundIds(e), o = 0; o < i.length; o++) {
          t._clearTimer(i[o]);
          var n = t._soundById(i[o]);
          if (n && !n._paused && (n._seek = t.seek(i[o]), n._rateSeek = 0, n._paused = !0, t._stopFade(i[o]), n._node)) if (t._webAudio) {
      ...
      stop: function(e, t) {
        ...
        else for (var o = i._getSoundIds(e), n = 0; n < o.length; n++) {
          i._clearTimer(o[n]);
      ...
      seek: function() {
        var e, t, i = this,
          o = arguments;
        if (0 === o.length ? t = i._sounds[0]._id : 1 === o.length ? 0 <= i._getSoundIds().indexOf(o[0]) ? t = parseInt(o[0], 10) : i._sounds.length && (t = i._sounds[0]._id, e = parseFloat(o[0])) : 2 === o.length && (e = parseFloat(o[0]), t = parseInt(o[1], 10)), void 0 !== t) if ("loaded" !== i._state || i._playLock) i._queue.push({
          event: "seek",
          action: function() {
            i.seek.apply(i, o)
          }
      ...
      unload: function() {
        ...
        for (var o = f._howls.indexOf(e), n = (0 <= o && f._howls.splice(o, 1), !0), i = 0; i < f._howls.length; i++) if (f._howls[i]._src === e._src || 0 <= e._src.indexOf(f._howls[i]._src)) {
          n = !1;
          break
        }
      ...
      off: function(e, t, i) {
        var o = this,
          n = o["_on" + e],
          a = 0;
        if ("number" == typeof t && (i = t, t = null), t || i) for (a = 0; a < n.length; a++) {
          var r = i === n[a].id;
          if (t === n[a].fn && r || !t && r) {
            n.splice(a, 1);
            break
        ...
        else for (var s = Object.keys(o), a = 0; a < s.length; a++) 0 === s[a].indexOf("_on") && Array.isArray(o[s[a]]) && (o[s[a]] = []);
        return o
      },
      once: function(e, t, i) {
    ...
    d = function(e, t) {
      ...
      "undefined" != typeof Promise && 1 === f.ctx.decodeAudioData.length ? f.ctx.decodeAudioData(e).then(o).
      catch (i) : f.ctx.decodeAudioData(e, o, i)
    },
    c = function(e, t) {
...
function() {
  ...
  HowlerGlobal.prototype._pos = [0, 0, 0], HowlerGlobal.prototype._orientation = [0, 0, -1, 0, 1, 0], HowlerGlobal.prototype.stereo = function(e) {
    var t = this;
    if (t.ctx && t.ctx.listener) for (var i = t._howls.length - 1; 0 <= i; i--) t._howls[i].stereo(e);
    return t
    ...
    var i = this;
    if (i._webAudio) if ("loaded" !== i._state) i._queue.push({
      event: "stereo",
      action: function() {
        i.stereo(e, t)
      }
    ...
    var n = this;
    if (n._webAudio) if ("loaded" !== n._state) n._queue.push({
      event: "pos",
      action: function() {
        n.pos(e, t, i, o)
      }
    ...
    t = {
      request: function(o) {
        return new Promise(function(e, t) {
          ...
          this.on("change", i), o = o || a.documentElement, Promise.resolve(o[n.requestFullscreen]()).
          catch (t)
        }.bind(this))
      },
      exit: function() {
        return new Promise(function(e, t) {
          ...
          this.isFullscreen ? (i = function() {
            this.off("change", i), e()
          }.bind(this), this.on("change", i), Promise.resolve(a[n.exitFullscreen]()).
          catch (t)) : e()
        }.bind(this))
      },
      toggle: function(e) {
...
var Warehouse = {
  create: function(e) {
    ...
    return t.index = e = void 0 === e ? "wid" : e, t.add = function(e) {
      ...
      for (var t = this.items.length, i = 0; i < t; i++) if (!this.items[i]) return e.array_index = i, void(this.items[i] = e);
      e.array_index = this.items.length, this.items.push(e)
    }, t.fetch = function(e, t) {
      void 0 === t && (t = this.index);
      for (var i = this.items.length, o = 0; o < i; o++) if (this.items[o] && this.items[o][t] == e) return this.items[o];
  ...
  Effect = (jv.Shelf = {
    create: function(e, t) {
      ...
      return i.label = e, i.useid = t, i.add = function(e) {
        ...
        for (var t = this.items.length, i = 0; i < t; i++) if (this.items[i] && this.items[i].id == e) return this.items[i];
        return null
      }, i.exists = function(e) {
  ...
  Map = {
    create: function(e, t, i) {
      ...
      return o.container = e, o.sheet = t, o.sheet_width = i, o.get = function(e, t) {
        ...
        for (var t in this.clear(), e = "string" == typeof e ? jv.fromString(e) : e) for (var i in e[t]) null != e[t][i] && null != e[t][i] && this.set(t, i, e[t][i] % this.sheet_width, Math.floor(e[t][i] / this.sheet_width))
      }, o.raw = function() {
        var e, t = [];
        for (e in this.map) for (var i in null == this.map[e] && (this.map[e] = []), t[e] = [], this.map[e]) t[e][i] = this.map[e][i].sprite;
        return t
      }, o.process = function(e) {
        for (var t in this.map) for (var i in null == this.map[t] && (this.map[t] = []), this.map[t]) null != this.map[t][i] && e(t, i, this.map[t][i])
      }, o.draw = function() {}, o
    }
  },
...
var tile_path = path,
  ...
  update_recipes = function() {
    var e, t, i, o, n, a;
    for (o in build_data = JSON.parse(jv.raw_build_data)) for (a in build_data[o].total = 0, build_data[o].r) build_data[o].total += build_data[o].r[a];
    var r = [],
      s = [],
  ...
  romanize = function(e) {
    var t, i = {
      ...
      o = "";
    for (t in i) for (; i[t] <= e;) o += t, e -= i[t];
    return o
  },
  ...
  update_edges = function() {
    ...
    for (var e, t, i, o = edge_container.edges = 0, n = -jv.update_x; n < jv.update_x; n++) for (e = -jv.update_y; e < jv.update_y; e++) map[o].edge.texture = get_edge(n, e, map[o].spr), map[o].edge.texture == edges[0][1] ? map[o].edge.visible = 0 : (edge_container.edges++, map[o].edge.visible = 1), "" !== dlevel ? cur_wall && map[o].spr == cur_wall ? (map[o].tint = 5592422, t = 0, (i = map[o + 1]) && i.spr != map[o].spr && (t += 4, i.tint = 11184810), (i = map[o - 1]) && i.spr != map[o].spr && (t += 1), (i = map[o + 26]) && i.spr != map[o].spr && (t += 2), (i = map[o - 26]) && i.spr != map[o].spr && (t += 8), map[o].cover.texture = cover[t], map[o].cover.visible = 1) : (map[o].cover.visible = 0, (i = map[o - 1]) && i.spr !== cur_wall && (map[o].tint = 16777215)) : map[o].cover.texture != tiles[0][0] && (map[o].cover.visible = 0), o += 1
  },
  playSound = (jv.update_map = function(e) {
    ...
    for (var t, i, o, n, a, r = e.tiles.split(":"), s = 0, l = [], d = [], c = -jv.update_x; c < jv.update_x; c++) for (i = -jv.update_y; i < jv.update_y; i++) {
    ...
    for (p in map_index) if (map_index[p].update !== now) {
      ...
      if (jv.last_button_down = Date.now(), jv.global_button_down = 0, this.texture != tiles[0][0]) {
        if (drag) {
          var e, t = 16,
            i = 16;
          touching && (t = 32, i = 42);
          for (var o, n, a, r, s = 0; s < item_length; s++) if (this.slot != s && this.x + t > inv[s].x + 0 && this.x + t < inv[s].x + 32 + 0 && this.y + i > inv[s].y && this.y + i < inv[s].y + 32) {
            e = s;
            break
          }
...
var parse = function(json) {
    if ("zip" === json.type) {
    ...
    else if ("mload" !== json.type) if ("music" === json.type) playMusic(json.m, 0, json.s);
    ...
    else if ("pass" !== json.type) if ("message" === json.type) {
    ...
    else if ("mi" !== json.type) if ("obj_tpl" === json.type) {
      var tpl = {};
      ...
      var mob = getMob(json.id);
      mob && mob.cleanup()
    } else if ("object" !== json.type) if ("tile" === json.type) {
  ...
  heading_style = (jv.ChatBox = {
    ...
    for (var i = c = 0; i < 5; i++) for (var o = 0; o < 3; o++) bld[c] = jv.InventorySlot.create(16 + 47 * o, 40 + 38 * i, c, build_pane), bld[c].build = 1, c += 1;
    ...
    if (jv.reconnect_dialog.connect1 = jv.Button.create(40, 40, 156, "USTexas", jv.reconnect_dialog, 34), jv.reconnect_dialog.connect1.ip = "ust.mysteralegacy.com", jv.reconnect_dialog.add(jv.reconnect_dialog.connect1), jv.reconnect_dialog.connect1.center(), jv.reconnect_dialog.connect1.top(35), jv.reconnect_dialog.connect1.on_click = function() {
      ...
      if (jv.metaconfig = mlmeta, jv.metaconfig.servers && jv.metaconfig.servers.length) for (s = 0; s < jv.metaconfig.servers.length; s++)(_ = jv.metaconfig.servers[s]) && (d = jv.reconnect_dialog["connect" + (s + 1)]) && (d.set_text(_.title), d.ip = _.ip);
  ...
  make_range = function(e, t) {
    ...
    i.add = function(e) {
      ...
      for (var t in this.list) if (this.list[t] == String(e)) return this.index = t, this.label.text = this.list[this.index], this.value = isNaN(Number(this.label.text)) ? this.label.text : Number(this.label.text), 1;
      return 0
    };
    var o, n = 0;
  ...
  init_ui = (jv.Button = {
    ...
    create: function(e, t, i, o, n, a, r) {
      ...
      return a = a || ui_container, s.interactive = !0, s.h = r || 24, s.w = i, s.selected = 0, s.series = n, jv.option_container || (jv.option_container = []), jv.option_container[n] || (jv.option_container[n] = []), jv.option_container[n].push(s), s.hitArea = new PIXI.Rectangle(0, 0, i, s.h), s.do_click = function() {
        ...
        for (var e in jv.option_container[this.series]) if (jv.option_container[this.series][e].selected) return jv.option_container[this.series][e]
        ...
        for (var t in jv.option_container[this.series]) if (jv.option_container[this.series][t].block_color == e || jv.option_container[this.series][t].label && jv.option_container[this.series][t].label.text == String(e)) return jv.option_container[this.series][t].select(), 1;
        return 0
      }, s.select = function(e) {
    ...
    var n, a, r, s;
    for (e.background = new PIXI.Graphics, e.background.beginFill(jv.color_base, o || 1), e.background.drawRect(0, 0, t, i), n = 0; n < t; n += 16) for (a = 0; a < i; a += 16) Math.random() * i <= a && (1.7 < 2 * Math.random() ? e.background.beginFill(jv.color_bright, .12) : e.background.beginFill(jv.color_dark, .4), t < n + (s = 16) && (s = t - n), i < a + (r = 16) && (r = i - a), e.background.drawRect(n, a, s, r));
    ...
    for (var i = c = 0; i < 5; i++) for (var o = 0; o < 3; o++) inv[c] = jv.InventorySlot.create(16 + 47 * o, 44 + 38 * i, c, inv_pane), c += 1;
...
jv.ready = function() {
  if (jv.retry_assets.length) jv.retried = 1, PIXI.loader.reset(), PIXI.loader.add(jv.retry_assets), PIXI.loader.load(jv.ready), console.log("Retrying assets: " + JSON.stringify(jv.retry_assets)), jv.retry_assets = [];
    ...
    tiles = jv.spritesheet(path + "data/misc/tile16.png" + vt, 16, 16, 2), items = jv.spritesheet(path + "data/misc/item16.png" + vt, 16, 16, 2), edges = jv.spritesheet(path + "data/misc/edges.png" + vt, 32, 32), compass = jv.sprite(path + "data/misc/compass.png" + vt), jv.action_button = jv.sprite(path + "data/misc/button.png" + vt), jv.pickup_button = jv.sprite(path + "data/misc/button.png" + vt), jv.chat_say = jv.sprite(path + "data/misc/chat_say.png" + vt), jv.chat_tell = jv.sprite(path + "data/misc/chat_tell.png" + vt), jv.chat_tribe = jv.sprite(path + "data/misc/chat_tribe.png" + vt), jv.chat_party = jv.sprite(path + "data/misc/chat_party.png" + vt), jv.chat_global = jv.sprite(path + "data/misc/chat_global.png" + vt), jv.buffs = jv.spritesheet(path + "data/misc/buffs.png" + vt, 8, 8), ui_container = jv.scene(), inventory = jv.sprite(), jv.theme(inventory, 160, 236), jv.star = jv.sprite(path + "data/misc/star.png" + vt), jv.star.x = 200, jv.star.y = 200, jv.buffbar = [], jv.buff_container = jv.scene(), jv.buff_container.scale.x = 2, jv.buff_container.scale.y = 2, ui_container.addChild(jv.buff_container), jv.buff_container.x = 194, jv.buff_container.y = 336, keyEnter.release = function() {
      ...
      if (!input_field.hasFocus && !editing && -1 !== me) for (var e in jv.Dialog.list) {
        if (jv.Dialog.list[e].visible && jv.Dialog.list[e].modal) return;
        jv.Dialog.list[e].visible = !1
      }
      ...
      if (e.preventDefault(), map_container.interactive && mapping_mode && (jv.mouseDown = 1, map_container.mousedown(0, 1), jv.mouseDown = 0), jv.inv_button.expanded) for (var t = 0; t < item_length; t++) jv.mouse.x > inv[t].x + 580 && jv.mouse.x < inv[t].x + 32 + 580 && jv.mouse.y > inv[t].y && jv.mouse.y < inv[t].y + 32 && inv[t].texture != tiles[0][0] && send({
        type: "d",
    ...
    for (var t, i = edge_container.y = 0, o = -jv.update_x; o < jv.update_x; o++) for (t = -jv.update_y; t < jv.update_y; t++) map[i] = new PIXI.Sprite, map[i].x = 32 * o, map[i].y = 32 * t, map_container.addChild(map[i]), map[i].anim = jv.sprite(tiles[6][Math.floor(20.375)]), map[i].anim.x = 32 * o, map[i].anim.y = 32 * t, map[i].anim.visible = 0, anim_map_container.addChild(map[i].anim), map[i].edge = jv.sprite(edges[0][1]), map[i].edge.x = 32 * o, map[i].edge.y = 32 * t, map[i].edge.spr = 16, map[i].edge.visible = 0, edge_container.addChild(map[i].edge), map[i].cover = jv.sprite(edges[0][1]), map[i].cover.x = 32 * o, map[i].cover.y = 32 * t - 20, map[i].cover.ry = map[i].cover.y, map[i].cover.visible = 0, player_container.addChild(map[i].cover), map[i].cover_mask = jv.sprite(edges[0][1]), map[i].cover_mask.x = 0, map[i].cover_mask.y = 0, map[i].cover_mask.visible = 0, map[i].cover.addChild(map[i].cover_mask), i += 1;
